...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="items-center px-4 mx-auto max-w-5/6 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center">
                        <x-application-logo class="block w-auto text-gray-800 fill-current h-9 dark:text-gray-200" />
                         <h1 class="ml-1 text-xl font-extrabold "> Noteify</h1>
                    </a>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('notes.index')" :active="request()->routeIs('notes.index','notes.create')" wire:navigate>
                        Notes
                    </x-nav-link>
